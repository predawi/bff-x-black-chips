		...
		<div class="container">
			<div class="content">
				<section class="wysiwyg">
					...
					<h2>A video in a iframe</h2>
					<p><iframe width="560" height="315" src="https://www.youtube.com/embed/DcJFdCmN98s?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></p>
					<h2>A table</h2>
					<table>
						<tbody>
							<tr>
					...
					<?php include 'blocks/wp/wp_gallery.php'; ?>
